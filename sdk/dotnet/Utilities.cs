...
namespace Pulumi.AutoDeploy
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AutoDeploy.version.txt");
    ...
    internal sealed class AutoDeployResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AutoDeployResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
