...
class AutoDeployerArgs:
    def __init__(__self__, *,
                 downstream_refs: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] downstream_refs: A list of `AutoDeployer.DownstreamRef` indicating which stacks should
               automatically be updated via Pulumi Deployments when this stack is successfully updated.
        :param pulumi.Input[_builtins.str] organization: The organization name for the AutoDeployer stack.
        :param pulumi.Input[_builtins.str] project: The project name for the AutoDeployer stack.
        :param pulumi.Input[_builtins.str] stack: The stack name for this AutoDeployer.
        """
    ...
    def downstream_refs(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def downstream_refs(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
@pulumi.type_token("auto-deploy:index:AutoDeployer")
class AutoDeployer(pulumi.ComponentResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 downstream_refs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="downstreamRefs")
    def downstream_refs(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        A list of `AutoDeployer.DownstreamRef` indicating which stacks should
        automatically be updated via Pulumi Deployments when this stack is successfully updated.
        """
    ...
    def downstream_webhooks(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
